...
func TestSafeSocketControl(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			wantErr: ErrUnsafeIP,
			net:     "tcp6",
			addr:    "[::ffff:169.254.169.254]:443", // ipv4-mapped and ipv4-compatible ipv6 address edge case from comment on https://www.agwa.name/blog/post/preventing_server_side_request_forgery_in_golang
		},
	}
